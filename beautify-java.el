(defun beautify-java (&optional dont-delete-comments)
  "Beautifies Java, if a prefix-argument is passed, no comments will be deleted"
  (interactive "P")
